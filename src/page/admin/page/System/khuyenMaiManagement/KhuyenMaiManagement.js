...
import useGetDataKhuyenMai from "./hook/useGetDataKhuyenMai";

const KhuyenMaiManagement = () => {
  // State
  ...
  // Get Data
  const { khuyenMaiData, isDataLoading, fetchData, isFetching } =
    useGetDataKhuyenMai("0", "0");
  ...
  return (
    <>
      ...
      <PopupMain
        title={
          _.isEmpty(showSlice?.initData?._id) ? "Thêm khuyến mãi" : "Sửa khuyến mãi"
        }
        showSlice={showSlice}
...
export default KhuyenMaiManagement;
