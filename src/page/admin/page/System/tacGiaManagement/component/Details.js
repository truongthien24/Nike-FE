...
import useCreateTacGia from "../hook/useCreateTacGia";
import useUpdateTacGia from "../hook/useUpdateTacGia";
...
const Details = ({
  ...
  const { mutate, isLoading: isSubmitting } = useCreateTacGia();
  ...
  const method = useForm({
    ...
    resolver: yupResolver(
      yup.object().shape({
        tenTacGia: yup.string().required("Nhập tên tác giả vào đi"),
        chiTietTacGia: yup.string().required("Nhập chi tiết tác giả vào"),
      })
    ),
  });
