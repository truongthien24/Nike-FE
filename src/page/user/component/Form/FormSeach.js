    ...
    <>
      <form className="w-full flex" onSubmit={handleSubmit(handleSearch)}>
        <div className="w-[70%] pr-[10px] xl:w-[60%] grid grid-cols-4 gap-[10px] lg:gap-[20px]">
          <div className="flex items-center h-full justify-center rounded-[10px] border-solid border-[1px] border-[#3790c7]">
            ...
            >
              <button
                type="button"
                className="bg-[#3790c7] rounded-l-[5px] h-full px-[5px] py-[5px] lg:px-[15px] lg:py-[5px]"
              >
                <Icon name="bed" color="#fff" font="small" />
              </button>
            </Popover>
            <div className="px-[5px] py-[5px] lg:px-[10px] lg:py-[7px] h-full rounded-r-[10px] text-[#3790c7] bg-[white] flex items-center justify-center w-full">
              {watch("soGiuong")}
            </div>
          </div>
          <div className="flex items-center col-span-2 h-full justify-center rounded-[10px] border-solid border-[1px] border-[#3790c7]">
            <button
              type="button"
              className="bg-[#3790c7] rounded-l-[5px] h-full px-[15px] py-[5px] hidden lg:block"
            >
        ...
        <div className="flex justify-end w-[30%] xl:w-[40%]">
          <button
            className="flex items-center justify-center bg-[#3790c7] text-white py-[5px] px-[10px] md:px-[20px] rounded-[7px] duration-300 hover:shadow-[#3790c7a6] hover:shadow-lg hover:translate-y-[-3px]"
            type="submit"
          >
            <Icon name="search" />
            <span className="ml-[5px] md:ml-[10px] text-[13px] md:text-[16px]">
              {t("findAHotel")}
            </span>
          </button>
        </div>
