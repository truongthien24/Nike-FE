...
export const ModalBooking = (props) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    sdt: yup
      .number()
      .typeError("Please input number fdsafadsfsf")
    ...
    >
      <div className="w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%] bg-white rounded-[10px] px-[30px] py-[20px]">
        <div className="flex items-center justify-between mb-[30px]">
          <h3 className="text-[20px] md:text-[25px] font-[500] text-[#3790c7]">
            {t("booking")}
          </h3>
          <span
            className="text-[25px] md:text-[30px] font-[500] translate-y-[-5px] text-[#3790c7] cursor-pointer"
            onClick={() => {
              setIsBooking(false);
            }}
          >
